...
SOURCE="/var/lib/libvirt/images/APP-1.qcow2"
...
sudo virt-install --name $user --ram 1024 --vcpus 1 --disk path=$DEST --import --os-variant fedora41 --network network=DMZ --graphics vnc --noautoconsole
